...
<body class="hold-transition sidebar-mini">
	<div class="wrapper" id="app">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="/" class="brand-link">
				<img src="<?php echo e(asset('img/logozip-new.png')); ?>" alt="ZIP Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					<div class="image">
						<img src="<?php echo e(asset('img/man.png')); ?>" class="img-circle elevation-2" alt="User Image">
					</div>
					<div class="info">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('thicong')): ?>
						<li class="nav-item">
						...
						<?php endif; ?>
						<?php if(Auth::user()->id == 269 || Auth::user()->id == 9318 || Auth::user()->id == 9320  || Auth::user()->id == 9367  || Auth::user()->id == 9368): ?>
							<li class="nav-item">
						...
						<?php endif; ?>
						<?php if(Auth::user()->id != 269 && Auth::user()->id != 9318 && Auth::user()->id != 9320 || Auth::user()->id != 9367  || Auth::user()->id != 9368): ?>
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ctv')): ?>
							<li class="nav-item">
							...
							<?php endif; ?>
							<?php if(Auth::user()->id == 3 || Auth::user()->id == 9261 ): ?>
							<li class="nav-item">
							...
							<?php endif; ?>
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('marketing')): ?>
							<li class="nav-item">
								<router-link to="/khach" class="nav-link">
									<i class="fa fa-circle-o nav-icon white"></i>
									<p>Tiềm năng doanh số</p>
							...
							<?php endif; ?>
							<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['sale','import'])): ?>
							<li class="nav-item">
								<router-link to="/dashboard" class="nav-link">
									<i class="nav-icon fa fa-dashboard green"></i>
									<p>
							...
							<li class="nav-item">
								...
								<ul class="nav nav-treeview">
									...
									<?php if(Auth::user()->id == 9074 || Auth::user()->id == 9003 || Auth::user()->id == 9334 || Auth::user()->id == 9378 || Auth::user()->id == 9097): ?>
									<li class="nav-item">
								...
								<ul class="nav nav-treeview">
									<li class="nav-item">
										<router-link to="/tin-tong-hop" class="nav-link">
											<i class="fa fa-circle-o nav-icon white"></i>
											<p>Tin Tổng Hợp <span class="right badge badge-danger"><?php echo e($tth); ?></span></p>
										</router-link>
									</li>
									<li class="nav-item">
										<router-link to="/teambuilding" class="nav-link">
											<i class="fa fa-circle-o nav-icon white"></i>
											<p>Tuyển Dụng <span class="right badge badge-danger"><?php echo e($tb); ?></span></p>
										</router-link>
									</li>
									<li class="nav-item">
										<router-link to="/khuyen-mai" class="nav-link">
											<i class="fa fa-circle-o nav-icon cyan"></i>
											<p>Khuyến Mại <span class="right badge badge-danger"><?php echo e($km); ?></span></p>
										</router-link>
									</li>
									<li class="nav-item">
										<router-link to="/thanh-tich" class="nav-link">
											<i class="fa fa-circle-o nav-icon white"></i>
											<p>Thành Tích <span class="right badge badge-danger"><?php echo e($tt); ?></span></p>
										</router-link>
									</li>
									<li class="nav-item">
										<router-link to="/du-an" class="nav-link">
											<i class="fa fa-circle-o nav-icon white"></i>
											<p>Dự Án <span class="right badge badge-danger"><?php echo e($da); ?></span></p>
										</router-link>
									</li>
									...
									<li class="nav-item">
										<router-link to="/danh-gia-khach-hang" class="nav-link">
											<i class="fa fa-circle-o nav-icon white"></i>
											<p>Đánh Giá Khách Hàng <span class="right badge badge-danger"><?php echo e($dg); ?></span></p>
										</router-link>
									</li>
							...
							<li class="nav-item has-treeview">
								...
								<ul class="nav nav-treeview">
									...
									<?php if(Auth::user()->id == 9074 || Auth::user()->id == 9197 || Auth::user()->id == 9015 || Auth::user()->id == 9003 || Auth::user()->id == 9134): ?>
									<li class="nav-item">
									...
									<?php endif; ?>
									<?php if(Auth::user()->id == 9074 || Auth::user()->id == 268 || Auth::user()->id == 269 || Auth::user()->id == 9015 || Auth::user()->id == 9003): ?>
									<li class="nav-item">
										<router-link to="/telepro" class="nav-link">
											<i class="fa fa-circle-o nav-icon cyan"></i>
											<p>Telepro</p>
									...
									<?php if(Auth::user()->id == 9074 || Auth::user()->id == 9003 ): ?>
									<li class="nav-item">
										<router-link to="/dai-ly" class="nav-link">
											<i class="fa fa-circle-o nav-icon white"></i>
											<p>Đại Lý</p>
							...
							<li class="nav-item has-treeview">
								...
								<ul class="nav nav-treeview">
									...
									<li class="nav-item">
										<router-link to="/giao-hang-san-pham" class="nav-link">
											<i class="fa fa-line-chart nav-icon"></i>
											<p>Báo Cáo SP Giao</p>
										</router-link>
									</li>
							...
							<li class="nav-item has-treeview">
								...
								<ul class="nav nav-treeview">
									...
									<li class="nav-item">
										<?php if(\Auth::user()->id == 9003 || \Auth::user()->id == 9074 || \Auth::user()->id == 9015): ?>
		...
		<footer class="main-footer">
			...
			<!-- Default to the left -->
			<strong>Copyright &copy; 2019 <a target="_blank" href="https://www.facebook.com/lovanlongvn/">Lỗ Văn Long</a>.</strong>.
		</footer>
	</div>
	<!-- ./wrapper -->
	...
	<script src="<?php echo e(asset('js/app.js?v=2240')); ?>"></script>
</body>
</html>
	<?php /**PATH /home/noith733/zip/resources/views/layouts/master.blade.php ENDPATH**/ ?>