...
<eExact xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="eExact-Schema.xsd">
  <Accounts>
    <Account code="<?php echo e($customer->id); ?>" status="A" type="C">
      <Name><?php echo e(\App\Common::khongdau($customer->name)); ?></Name>
      ...
      <Contacts>
        <Contact default="1" gender="M" status="A">
          <LastName><?php echo e(\App\Common::khongdau($customer->name)); ?></LastName>
          <FirstName></FirstName>
          ...
          <Addresses>
              <Address type="D" desc="">
              <AddressLine1><?php echo e(\App\Common::khongdau($customer->address_line1)); ?></AddressLine1>
      ...
      <Debtor number="<?php echo e($customer->id); ?>" code="<?php echo e($customer->id); ?>">
          <Currency code="VND" />
...
</eExact><?php /**PATH /home/noith733/zip/resources/views/contacts/xml.blade.php ENDPATH**/ ?>