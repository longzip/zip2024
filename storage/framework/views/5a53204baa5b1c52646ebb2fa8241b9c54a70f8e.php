  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo e(route('login')); ?>" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" id="password" placeholder="Password" name="password" required>
          <div class="input-group-append">
...
<?php /**PATH /home/noith733/zip/resources/views/auth/login.blade.php ENDPATH**/ ?>