...
class TaskableServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->mergeConfigFrom(__DIR__.'/../config/taskable.php', 'taskable');

        // Register the service the package provides.
        $this->app->singleton('taskable', function ($app) {
            return new Taskable;
        });
    }
