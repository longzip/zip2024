...
Route::group(['middleware' => 'auth:api'], function(){
    Route::apiResources([
        ...
        'baocaospgiao' => 'API\SPGiaoController',
    ]);
    // Route::get()
...
//Categories
    ...
    Route::get('loadsanphamgiao', 'API\SPGiaoController@listspgiao');
    Route::get('loadtongspgiao', 'API\SPGiaoController@loadtongspgiao');
