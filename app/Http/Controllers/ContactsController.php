...
class ContactsController extends Controller
{
    ...
    public function export(Request $request) 
    {
        ...
        $contacts = Contact::whereBetween('start_date',['2018-01-02','2022-01-01'])->orderBy('start_date','desc')->get();
        $count = 0;
        ...
        return Excel::download(new ContactsExport($contact), 'KHTN.xlsx');
    }
    ...
    public function exportlead(Request $request) 
    {
        ...
        $contacts = Lead::whereBetween ('start_date',['2019-06-02','2022-06-01'])->orderBy('start_date','desc')->get();
        $count = 0;
        $contact = $contacts->map(function ($value) use ($count){
            $a = '';
            $count += 1;
        ...
        return Excel::download(new ContactsExport($contact), 'KH15.xlsx');
    }
