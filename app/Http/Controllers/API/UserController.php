...
class UserController extends Controller
{
    ...
    */
    ...
    public function luongsale(Request $request)
    {
        ...
        if ($fil == 0) {
            if (\Auth::user()->id == 9074 || \Auth::user()->id == 270 || \Auth::user()->id == 9003 || \Auth::user()->id == 9097 || \Auth::user()->id == 9334 || \Auth::user()->id == 9015 || \Auth::user()->id == 9202 || \Auth::user()->id == 9378) {
                if ($fil == 0) {
...
// dd($cc);
        $list = $cc->map(function ($value) use ($p,$z,$fil,$calendar){
            ...
            if ($p == 4) {
                ...
                if ($value['id_nv'] == 9351 || $value['id_nv'] == 9364 || $value['id_nv'] == 9020 || $value['id_nv'] == 9156){
                    $luongcung = 5700000;
                    if ($value['id_nv'] == 9351){
                        $saletarget = 681327;
                    }
            ...
            if ($p == 5) {
                if ($value['id_nv'] == 9349 || $value['id_nv'] == 9371 || $value['id_nv'] == 9387 ) {
                    $luongcung = 4700000;
                    if ($value['id_nv'] == 9387){
                        $luongcung = 4700000*0.85;
                    }
                }
                ...
                if ($value['id_nv'] == 9385 || $value['id_nv'] == 9388 || $value['id_nv'] == 9383  || $value['id_nv'] == 9382  ){
                    $luongcung = 3700000*0.85;
                }

                if ($value['id_nv'] == 9364 || $value['id_nv'] == 9020 || $value['id_nv'] == 9156 || $value['id_nv'] == 9376){
                    $luongcung = 5700000;
                    if ($value['id_nv'] == 9364){
                        $saletarget = 3047112;
                    }
            ...
            if ($p == 6) {
                ...
                if ($value['id_nv'] == 9364 || $value['id_nv'] == 9020 || $value['id_nv'] == 9156 || $value['id_nv'] == 9376 || $value['id_nv'] == 9387 || $value['id_nv'] == 9393 || $value['id_nv'] == 9375){
                    if ($value['id_nv'] == 9375){
                        $saletarget = 625860;
                    }
                    if ($value['id_nv'] == 9393 ){
