...
class TeleproController extends Controller
{
    ...
    {
        $url = 'https://api.telepro.me/api/v1/jobs/1149/calls?&search=&call_converted=1&conversation_status=dongytraodoi&error=&keywords=&limit=25&package=&page='.$request->page.'&period=alltime&search=&status=success';
